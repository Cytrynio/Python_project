...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button =Button(image=true_button_image, command=self.get_check_answer_true)
        self.true_button.grid(column=0,row=2)

        false_button_image = PhotoImage(file="images/false.png")
        self.false_button =Button(image=false_button_image,command=self.get_check_answer_false)
